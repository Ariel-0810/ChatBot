...
describe('SignUpForm', () => {
  ...
  it('envía los datos correctamente al hacer submit', async () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('my_username02'), { target: { value: 'my_username02' } });
  ...
  it('muestra errores de validación si los campos están vacíos', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/Required, Please Enter your User Name/i)).toBeInTheDocument();
